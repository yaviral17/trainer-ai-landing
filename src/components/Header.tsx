...
export default function Header({ 
  ...
  return (
    <>
      <header className={`flex justify-between items-center px-20 py-4 sticky top-0 z-50 transition-colors duration-300  ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
