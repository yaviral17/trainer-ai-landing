  ...
  return (
    <div className={`min-h-screen font-sans transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <section className="relative px-6 py-12 md:py-24 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className={`mb-8 max-w-lg ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Track your spending, manage your accounts, and make smarter financial choices with our advanced budgeting tools and insights.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              >
                Get Started <ChevronRight className="ml-2 animate-pulse" size={18} />
              </button>
              <button 
              ...
              >
                ...
                {videoPlaying ? 'Pause Video' : 'Watch Video'}
              </button>
            </div>
          </div>
      ...
      <section className="px-6 py-12 max-w-6xl mx-auto">
        <div 
          className={`bg-gradient-to-r ${darkMode ? 'from-gray-800 to-gray-700' : 'from-black to-gray-900'} text-white p-6 rounded-xl flex flex-wrap md:flex-nowrap items-center justify-between gap-4 transform transition-transform duration-500 hover:scale-105`}
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="font-medium">Best AI Fitness App</p>
            </div>
          </div>
          ...
          >
            <span className="flex items-center">
              ...
              <span>Uiftry Premium</span>
            </span>
            <span className="text-xs text-white/80">Free Trial</span>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-12 md:py-24 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl font-black mb-8">Uiftry Premium</h2>
            
            <div className="space-y-8">
              <FeatureItem 
                icon={<Star className="text-orange-500" />}
                title="Budgeting Intervals"
                description="Set custom budgeting periods and receive personalized insights to help you stay on track with your financial goals."
                darkMode={darkMode}
                isHovered={hoveredFeature === 'budgeting'}
                onHover={() => setHoveredFeature(null)}
              ...
              <FeatureItem 
                ...
                description="Visualize your spending patterns with detailed charts and get actionable recommendations to optimize your finances."
                darkMode={darkMode}
                isHovered={hoveredFeature === 'analytics'}
                onHover={() => setHoveredFeature(null)}
                onLeave={() => setHoveredFeature(null)}
              />
              ...
              <FeatureItem 
                ...
                description="Connect and manage all your accounts in one place with real-time synchronization and unified transaction history."
                darkMode={darkMode}
                isHovered={hoveredFeature === 'sync'}
                onHover={() => setHoveredFeature(null)}
                onLeave={() => setHoveredFeature(null)}
              />
            </div>
